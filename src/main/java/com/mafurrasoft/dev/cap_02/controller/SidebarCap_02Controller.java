package com.mafurrasoft.dev.cap_02.controller;
...
public class SidebarCap_02Controller extends SelectorComposer<Component> {

    @Wire //Vai amarar o componente com o ID e o tipo igual a essa variavel;
    private Grid sidebar;

    SidebarPageConfigCap_02Impl sidebarPageConfigCap_02 = new SidebarPageConfigCap_02Impl();
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        for (SidebarPage sidebarPage : sidebarPageConfigCap_02.getPages()){
